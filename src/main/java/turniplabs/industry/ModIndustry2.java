...
public class ModIndustry2 implements ModInitializer {
    ...
    public static final Block COPPER_CABLE = BlockHelper.createBlock(MOD_ID, new BlockCable(nextBlock(), Material.iron, 32, 0, 32), "cable.copper", "cable_copper.png", Block.soundClothFootstep, 0.0f, 0.0f, 0.0f);
